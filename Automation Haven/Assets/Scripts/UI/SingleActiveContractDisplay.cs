...
public class SingleActiveContractDisplay : MonoBehaviour {
    ...
    public void Initialize(ContractManager.Contract contract, bool isExpanded) {
        ...
        companyTitle.text = contract.company.companyName;
        companyIcon.sprite = contract.company.companySO.companyLogo;

        SetTimeText(contract.timeLeft);
        ...
        contract.OnContractTimeLeftChanged += SetTimeText;
    }
