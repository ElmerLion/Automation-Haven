...
public class GridXZ<TGridObject> {
    ...
    public event EventHandler<int> OnGridObjectNetworkIDChanged;
    ...
    public void TriggerGridObjectNetworkIDChanged(int powerNetworkId) {
        OnGridObjectNetworkIDChanged?.Invoke(this, powerNetworkId);
    }
